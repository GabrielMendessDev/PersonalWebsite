    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='mailto:dev.gabrielmendess@gmail.com' >
                    ...
                    <BoxTexts>
                        <LinkText>Me envie um email</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxContact target="blank"  href='https://api.whatsapp.com/send?phone=5584998919920' >
                    ...
                    <BoxTexts>
                        <LinkText>(84) 99891-9920</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxCV href={"https://gabrielmendessdev.github.io/Curriculo/assets/Gabriel_Mendes_Curriculo.pdf"} download="Gabriel Mendes - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <BoxTexts>
                        <LinkTextCV>Download CV - Gabriel Mendes</LinkTextCV>
                    </BoxTexts>
                </BoxCV>

                <ContainerSocialMedias>
                    <SocialMedia target="blank"  href='https://www.linkedin.com/in/gabriel-mendes-bb5571264/'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank"  href='https://github.com/GabrielMendessDev'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank" href='https://instagram.com/dev_gabrielmendes'>
