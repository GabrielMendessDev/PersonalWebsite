    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='lucasgabriel16161@gmail.com' >
                ...
                <BoxCV href={"https://gabarbosa.com/static/media/cv.pdf"} download="Gabriel Mendes - Currículo">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContainerSocialMedias>
                    ...
                    <SocialMedia target="blank" href='https://instagram.com/gabrielmendesvv'>
